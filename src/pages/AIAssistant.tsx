...
export const AIAssistant = () => {
    ...
    const [activeTab, setActiveTab] = useState<'finder' | 'ask'>('finder');
            ...
            <div className="min-h-screen bg-[#0e1621] text-white selection:bg-[#10b981]/30">
                ...
                <div className="bg-[#0e1621] border-b border-[#2a3544] p-6 sticky top-0 z-20 backdrop-blur-md bg-opacity-80">
                    ...
                    <div className="max-w-7xl mx-auto mt-6 px-4">
                        <div className="flex gap-4 border-b border-[#2a3544]">
                            <button
                                onClick={() => setActiveTab('finder')}
                                className={`px-6 py-3 text-sm font-medium transition-all relative ${activeTab === 'finder' ? 'text-[#10b981]' : 'text-gray-400 hover:text-white'
                                    }`}
                            >
                                Career Finder
                                {activeTab === 'finder' && <div className="absolute bottom-0 left-0 w-full h-0.5 bg-[#10b981]" />}
                            </button>
                            <button
                                onClick={() => setActiveTab('ask')}
                                className={`px-6 py-3 text-sm font-medium transition-all relative ${activeTab === 'ask' ? 'text-[#10b981]' : 'text-gray-400 hover:text-white'
                                    }`}
                            >
                                Ask Anything
                                {activeTab === 'ask' && <div className="absolute bottom-0 left-0 w-full h-0.5 bg-[#10b981]" />}
                            </button>
                        </div>
                    </div>
                </div>
